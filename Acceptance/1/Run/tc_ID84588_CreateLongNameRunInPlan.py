...
class CreateLongNameRunInPlan(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_CreateLongNameRunInPlan(self):
        sel = self.selenium
	...
	testrunName=cc().getFormatName(self,sel,absPath,"testrunName")+\
		" - For long run name testing long long long long long long long long long long long long run name"
