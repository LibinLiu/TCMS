...
class CloneSomeCasesInPlan(unittest.TestCase):
	...
	cc().saveCloneTestCase(self,sel,selectPlan="Use Sameplan",selectCloneCaseIds=[testcaseId1,testcaseId2],\
		unSelectCloneCaseIds=[testcaseId3]) #choose not to clone the 3rd case, just clone the 1st,2nd cases
