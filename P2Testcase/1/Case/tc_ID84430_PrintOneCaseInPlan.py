...
class PrintOneCaseInPlan(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_PrintOneCaseInPlan(self):
        sel = self.selenium
	...
	cc().verifyPrintTestPlanPageIsReady(self,sel,{env.testplanId4:env.testplanName4},\
		testcaseIdNames={env.testcaseId41:env.testcaseName41},\
		testcaseNotShowIdNames={env.testcaseId42:env.testcaseName42})
