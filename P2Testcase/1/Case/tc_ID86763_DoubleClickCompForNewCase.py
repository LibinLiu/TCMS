...
class DoubleClickCompForNewCase(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_DoubleClickCompForNewCase(self):
        sel = self.selenium
	...
	cc().addComponentInCreateCase(self,sel,{env.componentId11:env.component11},wayToAdd="Double Click")
