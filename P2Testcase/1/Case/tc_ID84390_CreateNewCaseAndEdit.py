...
class CreateNewCaseAndEdit(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_CreateNewCaseAndEdit(self):
        sel = self.selenium
	...
	cc().clickActionInCreateCase(self,sel,"Save and continue editing")
	cc().verifyEditTestCasePageIsReady(self,sel,testcaseName)
