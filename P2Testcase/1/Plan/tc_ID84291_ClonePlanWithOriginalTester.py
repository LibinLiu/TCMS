...
class ClonePlanWithOriginalTester(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_ClonePlanWithOriginalTester(self):
        sel = self.selenium
	...
	cc().fillDataForCloneTestPlan(self,sel,keepDefaultTesterForCases="on")
	...
	cc().verifyCaseDefaultTesterInPlan(self,sel,"1",env.user2)
