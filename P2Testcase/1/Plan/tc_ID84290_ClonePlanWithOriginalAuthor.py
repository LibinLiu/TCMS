...
class ClonePlanWithOriginalAuthor(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_ClonePlanWithOriginalAuthor(self):
        sel = self.selenium
	...
	cc().fillDataForCloneTestPlan(self,sel,keepOriginalAuthor="on")
