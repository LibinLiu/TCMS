...
class ClonePlanWithCreateCaseLink(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_ClonePlanWithCreateCaseLink(self):
        sel = self.selenium
	...
	cc().fillDataForCloneTestPlan(self,sel,createACopyForCases="off")
