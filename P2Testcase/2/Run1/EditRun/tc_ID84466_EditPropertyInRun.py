...
class EditPropertyInRun(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_EditPropertyInRun(self):
        sel = self.selenium
	...
	cc().editPropertyInRun(self,sel,env.runproperty1,env.runpropvalue11,env.runpropvalue12,needRemove=False)
