...
class CreateRunByChangeProdVer(unittest.TestCase):
    def setUp(self):
        self.verificationErrors = []
        self.selenium = selenium(env.host, env.port, env.browser, env.domain)
        self.selenium.start()
    
    def test_CreateRunByChangeProdVer(self):
        sel = self.selenium
	...
	#(2)Execute test
	cc().createCustomizedTestRunFromPlan(self,sel,testplanName,summary=testrunName,product=env.product1,\
		prodversion=env.prodversion12)
